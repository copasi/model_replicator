...
We now create several neuron network motifs inspired by the work of Giannari and Astolfi (3), except that here all the synapses are chemical (Destexhe *et al.* type) whereas in their publication they have a mix of chemical and electrical synapses (the latter can also be generated by *sbmodler* however a combination of the two is not possible currently).
