...
<!-- generated with COPASI 4.44 (Build 294) (http://www.copasi.org) at 2024-06-27T19:36:17Z -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Metabolite_0">
    ...
    <CopasiMT:is rdf:resource="urn:miriam:kegg.compound:C00076"/>
      ...
      <Metabolite key="Metabolite_1" name="IP3" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Metabolite_1">
    ...
    <CopasiMT:is rdf:resource="urn:miriam:kegg.compound:C01245" />
      ...
      <Metabolite key="Metabolite_2" name="Ca_ER" simulationType="assignment" compartment="Compartment_1" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelValue_5">
      ...
      <ModelValue key="ModelValue_6" name="d3" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#ModelValue_6">
      ...
      <ModelValue key="ModelValue_7" name="C0" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelValue_11">
      ...
      <ModelValue key="ModelValue_12" name="d5" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#Reaction_2">
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_7624" name="h" value="0.856847"/>
...
<rdf:Description rdf:about="#Reaction_3">
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_7628" name="Vmax" value="0.7"/>
...
<rdf:Description rdf:about="#Reaction_5">
        ...
        <ListOfConstants>
          ...
          <Constant key="Parameter_7505" name="Vmax" value="0.7"/>
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Compartments[Cytoplasm],Vector=Metabolites[Ca]" value="16966434410934114" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Compartments[Cytoplasm],Vector=Metabolites[IP3]" value="15540543414550456" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Compartments[ER],Vector=Metabolites[Ca_ER]" value="1.187461717589066e+18" type="Species" simulationType="assignment"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Values[Q2]" value="0.16863309947686161" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Values[h]" value="0.85684708911839735" type="ModelValue" simulationType="ode"/>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Reactions[chan]" type="Reaction">
            ...
            <ModelParameter cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Reactions[chan],ParameterGroup=Parameters,Parameter=h" value="0.85684708911839735" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
...
<rdf:Description rdf:about="#ModelParameterSet_3">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Compartments[ER],Vector=Metabolites[Ca_ER]" value="5.8593801989189192e+18" type="Species" simulationType="assignment"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Values[r_L]" value="0.11" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Values[v_ER]" value="0.90000000000000002" type="ModelValue" simulationType="fixed"/>
    ...
    <PlotSpecification name="Time course" type="Plot2D" active="1" taskTypes="">
      ...
      <ListOfPlotItems>
        ...
        <PlotItem name="[Ca_er]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=ChI model of calcium oscillations,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=ChI model of calcium oscillations,Vector=Compartments[ER],Vector=Metabolites[Ca_ER],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
