...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does include a reverse process that creates the reactants from the products.
  ...
  <Model key="Model_2" name="a set of 2 replicas of Simple model of glycolytic oscillations" simulationType="time" timeUnit="1" volumeUnit="1" areaUnit="1" lengthUnit="1" quantityUnit="1" type="deterministic" avogadroConstant="6.0221407599999999e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<rdf:Description rdf:about="#Metabolite_5">
      ...
      <Metabolite key="Metabolite_6" name="Y_medium" simulationType="reactions" compartment="Compartment_3" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelValue_5">
      ...
      <ModelValue key="ModelValue_6" name="k_Y_transport" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#Reaction_8">
      ...
      <Reaction key="Reaction_9" name="t_Y_1-medium" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_9">
      ...
      <Reaction key="Reaction_10" name="t_Y_2-medium" reversible="true" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
xmlns:dcterms="http://purl.org/dc/terms/"
xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelParameterSet_2">
        ...
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Compartments[Cell_1]" value="1" type="Compartment" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Compartments[Cell_2]" value="1" type="Compartment" simulationType="fixed"/>
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[v_1]" value="3" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[k_1]" value="3.8399999999999999" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[v_2]" value="3" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[k_2]" value="3.8399999999999999" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[k_Y_transport]" value="3.2000000000000002" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v1_1]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v1_1],ParameterGroup=Parameters,Parameter=v" value="3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[v_1],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v2_1]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v2_1],ParameterGroup=Parameters,Parameter=k1" value="1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v3_1]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v3_1],ParameterGroup=Parameters,Parameter=k1" value="3.8399999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[k_1],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v1_2]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v1_2],ParameterGroup=Parameters,Parameter=v" value="3" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[v_2],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v2_2]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v2_2],ParameterGroup=Parameters,Parameter=k1" value="1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v3_2]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[v3_2],ParameterGroup=Parameters,Parameter=k1" value="3.8399999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[k_2],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[t_Y_1-medium]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[t_Y_1-medium],ParameterGroup=Parameters,Parameter=k1" value="3.2000000000000002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[k_Y_transport],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[t_Y_1-medium],ParameterGroup=Parameters,Parameter=k2" value="3.2000000000000002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[k_Y_transport],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[t_Y_2-medium]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[t_Y_2-medium],ParameterGroup=Parameters,Parameter=k1" value="3.2000000000000002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[k_Y_transport],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
            <ModelParameter cn="CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Reactions[t_Y_2-medium],ParameterGroup=Parameters,Parameter=k2" value="3.2000000000000002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=a set of 2 replicas of Simple model of glycolytic oscillations,Vector=Values[k_Y_transport],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
