...
<!-- generated with COPASI 4.44 (Build 292) (http://www.copasi.org) at 2024-06-18T17:23:24Z -->
...
<rdf:Description rdf:about="#Compartment_11">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_21" name="X" simulationType="reactions" compartment="Compartment_11" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_21">
      ...
      <Metabolite key="Metabolite_20" name="Y" simulationType="reactions" compartment="Compartment_11" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_20">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_21" name="v" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#ModelValue_21">
      ...
      <ModelValue key="ModelValue_20" name="k" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#ModelValue_20">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_39" name="v1" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_39">
        ...
        <ListOfConstants>
          <Constant key="Parameter_4672" name="v" value="3"/>
        </ListOfConstants>
...
<rdf:Description rdf:about="#Reaction_38">
        ...
        <ListOfConstants>
          <Constant key="Parameter_5532" name="k1" value="1"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_37" name="v3" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_37">
        ...
        <ListOfConstants>
          <Constant key="Parameter_5660" name="k1" value="3.84"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[k]" value="3.8399999999999999" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          ...
          <ModelParameterGroup cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Reactions[v3]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Reactions[v3],ParameterGroup=Parameters,Parameter=k1" value="3.8399999999999999" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
    ...
    <InitialState type="initialState">
      0 4.9199999999999999 0.77000000000000002 1 3 3.8399999999999999 
    </InitialState>
  </Model>
  <ListOfTasks>
  ...
  <GUI>
    <ListOfSliders>
      <Slider key="Slider_3" associatedEntityKey="Task_29" objectCN="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[k],Reference=InitialValue" objectType="float" objectValue="3.84" minValue="0.384" maxValue="38.4" tickNumber="1000" tickFactor="100" scaling="logarithmic"/>
      <Slider key="Slider_2" associatedEntityKey="Task_29" objectCN="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[v],Reference=InitialValue" objectType="float" objectValue="3" minValue="0.03" maxValue="30" tickNumber="1000" tickFactor="100" scaling="logarithmic"/>
    </ListOfSliders>
  </GUI>
