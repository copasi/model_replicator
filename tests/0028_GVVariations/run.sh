...
sbmodelr -t G -o t.cps -n ../sources/test08_2.gv ../sources/GeneExpressionUnit.cps 3 1> output 2> /dev/null
...
sbmodelr -g G --ignore-compartments -o t22.cps -n ../sources/test22_6.gv ../sources/GeneExpressionUnit.cps 6 1> output 2> /dev/null
...
sbmodelr -g G --ignore-compartments -o t16.cps -n ../sources/test16_12.gv ../sources/GeneExpressionUnit.cps 12 1> output 2> /dev/null
...
sbmodelr -g G --ignore-compartments -o t15.cps -n ../sources/test15_11.gv ../sources/GeneExpressionUnit.cps 11 1> output 2> /dev/null
...
sbmodelr -g G --ignore-compartments -o t10.cps -n ../sources/test10_8.gv ../sources/GeneExpressionUnit.cps 8 1> output 2> /dev/null
...
sbmodelr -g G --ignore-compartments -o t11.cps -n ../sources/test11_12.gv ../sources/GeneExpressionUnit.cps 12 1> output 2> /dev/null
