...
sbmodelr -g G --grn-a 1 -n ../sources/1to2.gv ../sources/GeneExpressionUnit.cps 2 2 > output 2>&1
...
sbmodelr -g G -n ../sources/CoopSW8_001.dot ../sources/GeneExpressionUnit.cps 3 > output 2>&1
...
sbmodelr -g G -n ../sources/twins.gv ../sources/GeneExpressionUnit.cps 2 > output 2>&1
...
sbmodelr -t G void.cps 2 > output 2>&1
...
sbmodelr -g G -n void.gv ../sources/GeneExpressionUnit.cps 2 > output 2>&1
...
sbmodelr -g G --grn-a "-3" -n ../sources/1to2.gv ../sources/GeneExpressionUnit.cps 2 > output 2>&1
...
sbmodelr -g G --grn-a 2 -n ../sources/1to2.gv ../sources/GeneExpressionUnit.cps 2 > output 2>&1
...
sbmodelr -g G --grn-h 0 -n ../sources/1to2.gv ../sources/GeneExpressionUnit.cps 2 > output 2>&1
...
sbmodelr -g G --grn-h 11 -n ../sources/1to2.gv ../sources/GeneExpressionUnit.cps 2 > output 2>&1
...
# continue issuing the same error code for --grn-h out of bounds
sbmodelr -g G --grn-h 0.5 -n ../sources/1to2.gv ../sources/GeneExpressionUnit.cps 2 > output 2>&1
...
sbmodelr --add-medium ../sources/GeneExpressionUnit.cps 2 > output 2>&1
