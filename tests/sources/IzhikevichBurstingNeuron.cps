  ...
  <rdf:Description rdf:about="#Model_0">
    ...
    <dcterms:bibliographicCitation>
      <rdf:Bag>
        <rdf:li>
          <rdf:Description>
            <CopasiMT:isDescribedBy rdf:resource="http://identifiers.org/pubmed/18244602"/>
          </rdf:Description>
        </rdf:li>
      </rdf:Bag>
    </dcterms:bibliographicCitation>
    ...
    <CopasiMT:is>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/biomodels.db/MODEL4880479792"/>
      </rdf:Bag>
    </CopasiMT:is>
    <CopasiMT:is>
      <rdf:Bag>
        <rdf:li rdf:resource="http://identifiers.org/biomodels.db/BIOMD0000000127"/>
      </rdf:Bag>
    </CopasiMT:is>
...
<rdf:Description rdf:about="#Event_0">
        ...
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[v]">
            <Expression>
              &lt;CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[c],Reference=Value>
            </Expression>
          </Assignment>
          <Assignment target="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[U]">
            <Expression>
              &lt;CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[U],Reference=Value>+&lt;CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[d],Reference=Value>
            </Expression>
          </Assignment>
        </ListOfAssignments>
      </Event>
...
<rdf:Description rdf:about="#Event_1">
        ...
        <ListOfAssignments>
          <Assignment target="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[i]">
            <Expression>
              10
            </Expression>
          </Assignment>
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Izhikevich2003_SpikingNeuron" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Compartments[cell]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[a]" value="0.02" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[b]" value="0.20000000000000001" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[c]" value="-65" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[d]" value="8" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[Vthresh]" value="30" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[i]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[v]" value="-70" type="ModelValue" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[U]" value="-14" type="ModelValue" simulationType="ode"/>
        </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 -70 -14 1 0.02 0.20000000000000001 -65 8 30 0 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1" taskTypes="">
      ...
      <ListOfPlotItems>
        <PlotItem name="v" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[v],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="U" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[U],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="i" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Izhikevich2003_SpikingNeuron,Vector=Values[i],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
