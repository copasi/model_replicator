...
<!-- generated with COPASI 4.43 (Build 288) (http://www.copasi.org) at 2024-05-13T02:21:48Z -->
...
<h2>COPASI notes</h2>
<p>The species in this model, x, y, and z, are not concentrations, but rather voltages, and thus can be can be negative. They are defined as type <i>ODE</i>.</p>
...
<rdf:Description rdf:about="#ModelParameterSet_1">
        ...
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Vector=Compartments[compartment]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Vector=Compartments[compartment],Vector=Metabolites[x]" value="-9.6980143486826072e+23" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Vector=Compartments[compartment],Vector=Metabolites[y]" value="-7.2065939588924699e+24" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Vector=Compartments[compartment],Vector=Metabolites[z]" value="-6.2589131116852491e+21" type="Species" simulationType="ode"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Vector=Values[I]" value="0.29999999999999999" type="ModelValue" simulationType="fixed"/>
    ...
    <InitialState type="initialState">
      0 -9.6980143486826072e+23 -7.2065939588924699e+24 -6.2589131116852491e+21 -1.3333333333333333 1 1 3 1 5 0.29999999999999999 0.001 4 -1.6000000000000001 
    </InitialState>
  </Model>
  <ListOfTasks>
      ...
      <ListOfPlotItems>
        <PlotItem name="x" type="Curve2D">
          ...
          <ListOfChannels>
            ...
            <ChannelSpec cn="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Vector=Compartments[compartment],Vector=Metabolites[x],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="y" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Vector=Compartments[compartment],Vector=Metabolites[y],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="z" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Vector=Compartments[compartment],Vector=Metabolites[z],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
  ...
  <GUI>
    <ListOfSliders>
      <Slider key="Slider_4" associatedEntityKey="Task_18" objectCN="CN=Root,Model=Hindmarsh-Rose model of bursting neuron,Vector=Values[I],Reference=InitialValue" objectType="float" objectValue="0.3" minValue="-1" maxValue="5" tickNumber="1000" tickFactor="100" scaling="linear"/>
    </ListOfSliders>
  </GUI>
