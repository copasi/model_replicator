...
<!-- generated with COPASI 4.44 (Build 292) (http://www.copasi.org) at 2024-06-14T00:11:58Z -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
  ...
  <Model key="Model_0" name="Simple model of glycolytic oscillations" simulationType="time" timeUnit="1" volumeUnit="1" areaUnit="1" lengthUnit="1" quantityUnit="1" type="deterministic" avogadroConstant="6.0221407599999999e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_0">
    ...
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2024-05-07T00:35:40Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
    <dcterms:creator>
      <rdf:Description>
...
<rdf:Description rdf:about="#Compartment_0">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_8" name="X" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_8">
      ...
      <Metabolite key="Metabolite_7" name="Y" simulationType="reactions" compartment="Compartment_0" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_7">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_2" name="v" simulationType="fixed" addNoise="false">
      </ModelValue>
      <ModelValue key="ModelValue_1" name="k" simulationType="fixed" addNoise="false">
      </ModelValue>
    </ListOfModelValues>
    <ListOfReactions>
      <Reaction key="Reaction_13" name="v1" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_13">
        ...
        <ListOfConstants>
          <Constant key="Parameter_8817" name="v" value="4.04689"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_12" name="v2" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_12">
        ...
        <ListOfConstants>
          <Constant key="Parameter_11540" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
              <SourceParameter reference="Parameter_11540"/>
            </CallParameter>
      ...
      <Reaction key="Reaction_11" name="v3" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Reaction_11">
        ...
        <ListOfConstants>
          <Constant key="Parameter_5319" name="k1" value="2.64442"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell],Vector=Metabolites[X]" value="4.9100000000000001" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell],Vector=Metabolites[Y]" value="0.77000000000000002" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[v]" value="4.046888647774959" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[k]" value="2.6444248179620202" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Reactions[v1]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Reactions[v1],ParameterGroup=Parameters,Parameter=v" value="4.046888647774959" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[v],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Reactions[v2]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Reactions[v2],ParameterGroup=Parameters,Parameter=k1" value="1" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Reactions[v3]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Reactions[v3],ParameterGroup=Parameters,Parameter=k1" value="2.6444248179620202" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[k],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
        </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 4.9100000000000001 0.77000000000000002 1 4.046888647774959 2.6444248179620202 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_14" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_7" target="tc.txt" append="0" confirmOverwrite="0"/>
      <Problem>
    ...
    <Task key="Task_8" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <ParameterText name="ObjectiveExpression" type="expression">
          (&lt;CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell],Vector=Metabolites[X],Reference=Concentration>-&lt;CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell],Vector=Metabolites[Y],Reference=Concentration>)^2
        </ParameterText>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[k],Reference=InitialValue"/>
            <Parameter name="LowerBound" type="cn" value="1e-06"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
            <Parameter name="StartValue" type="float" value="2.6444248180000001"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[v],Reference=InitialValue"/>
            <Parameter name="LowerBound" type="cn" value="1e-06"/>
            <Parameter name="UpperBound" type="cn" value="1000000"/>
    ...
    <Task key="Task_34" name="Parameter Estimation" type="parameterFitting" scheduled="false" updateModel="false">
  ...
  <GUI>
    <ListOfSliders>
      <Slider key="Slider_4" associatedEntityKey="Task_14" objectCN="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[k],Reference=InitialValue" objectType="float" objectValue="2.64442" minValue="0.384" maxValue="38.4" tickNumber="1000" tickFactor="100" scaling="logarithmic"/>
      <Slider key="Slider_5" associatedEntityKey="Task_14" objectCN="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[v],Reference=InitialValue" objectType="float" objectValue="4.04689" minValue="0.03" maxValue="30" tickNumber="1000" tickFactor="100" scaling="logarithmic"/>
    </ListOfSliders>
  </GUI>
