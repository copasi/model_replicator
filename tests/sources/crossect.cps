...
<!-- generated with COPASI 4.44 (Build 292) (http://www.copasi.org) at 2024-06-13T23:21:37Z -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
  ...
  <Model key="Model_1" name="Simple model of glycolytic oscillations" simulationType="time" timeUnit="1" volumeUnit="1" areaUnit="1" lengthUnit="1" quantityUnit="1" type="deterministic" avogadroConstant="6.0221407599999999e+23">
    <MiriamAnnotation>
<rdf:RDF
...
<p style="font-size:small"><b>CC0 1.0 Universal</b>: To the extent possible under law, all copyright and related or neighbouring rights to this encoded model have been dedicated to the public domain worldwide. You can copy, modify, distribute and perform the work, even for commercial purposes, all without asking permission. Please refer to <a href="http://creativecommons.org/publicdomain/zero/1.0/" title="Creative Commons CC0">CC0 Public Domain Dedication</a> for more information.</p></body>
    ...
    <ListOfCompartments>
      <Compartment key="Compartment_4" name="Cell" simulationType="fixed" dimensionality="3" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Compartment_4">
    ...
    <ListOfMetabolites>
      <Metabolite key="Metabolite_3" name="X" simulationType="reactions" compartment="Compartment_4" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
<rdf:Description rdf:about="#Metabolite_3">
      ...
      <Metabolite key="Metabolite_4" name="Y" simulationType="reactions" compartment="Compartment_4" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelValue_1">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_4" name="v1" reversible="false" fast="false" addNoise="false">
        <ListOfProducts>
          <Product metabolite="Metabolite_3" stoichiometry="1"/>
        </ListOfProducts>
        <ListOfConstants>
          <Constant key="Parameter_6351" name="v" value="4.04689"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_5" name="v2" reversible="false" fast="false" addNoise="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_3" stoichiometry="1"/>
          <Substrate metabolite="Metabolite_4" stoichiometry="2"/>
        </ListOfSubstrates>
        <ListOfProducts>
          <Product metabolite="Metabolite_4" stoichiometry="3"/>
        </ListOfProducts>
        <ListOfConstants>
          <Constant key="Parameter_11476" name="k1" value="1"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
              <SourceParameter reference="Parameter_11476"/>
            </CallParameter>
      ...
      <Reaction key="Reaction_6" name="v3" reversible="false" fast="false" addNoise="false">
        <ListOfSubstrates>
          <Substrate metabolite="Metabolite_4" stoichiometry="1"/>
        </ListOfSubstrates>
        <ListOfConstants>
          <Constant key="Parameter_4603" name="k1" value="2.64442"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
...
<rdf:Description rdf:about="#ModelParameterSet_1">
  ...
  <ListOfTasks>
    ...
    <Task key="Task_27" name="Time-Course" type="timeCourse" scheduled="true" updateModel="false">
      <Report reference="Report_20" target="tc.txt" append="0" confirmOverwrite="0"/>
      <Problem>
      ...
      <Problem>
        ...
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            ...
            <Parameter name="Object" type="cn" value="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Reactions[v2],ParameterGroup=Parameters,Parameter=k1,Reference=Value"/>
    ...
    <Task key="Task_33" name="Cross Section" type="crosssection" scheduled="false" updateModel="false">
      <Problem>
        ...
        <Parameter name="Threshold" type="float" value="1"/>
        <Parameter name="DelayOutputUntilConvergence" type="bool" value="0"/>
        <Parameter name="OutputConvergenceTolerance" type="float" value="0"/>
        <ParameterText name="TriggerExpression" type="expression">
          
        </ParameterText>
        <Parameter name="SingleVariable" type="cn" value="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell],Vector=Metabolites[X],Reference=Concentration"/>
      </Problem>
      <Method name="Deterministic (LSODA)" type="Deterministic(LSODA)">
        <Parameter name="Integrate Reduced Model" type="bool" value="0"/>
        <Parameter name="Relative Tolerance" type="unsignedFloat" value="9.9999999999999995e-07"/>
    ...
    <PlotSpecification name="Scan of Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1" taskTypes="Scan">
      ...
      <ListOfPlotItems>
        <PlotItem name="[X]" type="Curve2D">
          ...
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Reactions[v2],ParameterGroup=Parameters,Parameter=k1,Reference=Value"/>
            <ChannelSpec cn="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Compartments[Cell],Vector=Metabolites[X],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[Y]" type="Curve2D">
  ...
  <GUI>
    <ListOfSliders>
      <Slider key="Slider_3" associatedEntityKey="Task_27" objectCN="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[k],Reference=InitialValue" objectType="float" objectValue="2.64442" minValue="0.384" maxValue="38.4" tickNumber="1000" tickFactor="100" scaling="logarithmic"/>
      <Slider key="Slider_4" associatedEntityKey="Task_27" objectCN="CN=Root,Model=Simple model of glycolytic oscillations,Vector=Values[v],Reference=InitialValue" objectType="float" objectValue="4.04689" minValue="0.03" maxValue="30" tickNumber="1000" tickFactor="100" scaling="logarithmic"/>
    </ListOfSliders>
  </GUI>
