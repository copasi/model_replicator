...
# run sbmodelr
../../sbmodelr -g G --pn G 0.8 uni --grn-a -1 --grn-h 4 -n ../sources/3circle.gv -o repressilator.cps --ignore-compartments ../sources/GeneExpressionUnit.cps 3 1> output 2> /dev/null
